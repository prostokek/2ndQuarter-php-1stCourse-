...
php;
    ...
    <div>
        ...
        <form method='POST' action = '?page=product&id={$productId}&func=addCommentaryToAProduct'>
...
function addCommentaryToAProduct() {
    if(!empty($_POST['nameOfSender']) && !empty($_POST['commentary'])) {
        global $productId;
